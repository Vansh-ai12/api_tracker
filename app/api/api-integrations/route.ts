  ...
  try {
    ...
    const { data: newIntegration, error: insertError } = await supabase
      ...
      .insert({
        ...
        usage_current: usage_current !== undefined ? parseFloat(String(usage_current)) : null,
        usage_limit: usage_limit !== undefined ? parseFloat(String(usage_limit)) : null,
        usage_unit: usage_unit || "tokens",
        credits_remaining: credits_remaining !== undefined ? parseFloat(String(credits_remaining)) : null,
        credit_limit: credit_limit !== undefined ? parseFloat(String(credit_limit)) : null,
    ...
    if (insertError || !newIntegration) {
      console.error("[api-integrations] Insert error:", insertError);
